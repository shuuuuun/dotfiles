...
alias github='git remote -v | perl -0ne '"'"'print "$1" if (/(https?:\/\/github\.com\/[^\/]+\/[^\/]+)\.git/)'"'"' | xargs -I url open url'
alias gh-page='git remote -v | perl -0ne '"'"'print "https://$1.github.io/$2/" if (/[https?:\/\/|git\@]github\.com[\/|:]([^\/]+)\/([^\/]+)\.git/)'"'"' | xargs -I url open url'
