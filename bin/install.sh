...
DOTFILES=(.bash_profile .bashrc .gitignore_global .gitconfig.local .gitconfig .vimrc .sh .zprofile .zshrc .tigrc .ripgreprc .tmux.conf .config/peco/config.json .config/lf/lfrc .config/direnv/direnvrc .rubocop.yml)
